...
pub const PSCAN_SEMICOLON: PsqlScanResult = 0;
pub const PSCAN_BACKSLASH: PsqlScanResult = 1;
pub const PSCAN_INCOMPLETE: PsqlScanResult = 2;
pub const PSCAN_EOL: PsqlScanResult = 3;
pub type PsqlScanResult = libc::c_uint;
pub const PROMPT_READY: _promptStatus = 0;
pub const PROMPT_CONTINUE: _promptStatus = 1;
pub const PROMPT_COMMENT: _promptStatus = 2;
pub const PROMPT_SINGLEQUOTE: _promptStatus = 3;
pub const PROMPT_DOUBLEQUOTE: _promptStatus = 4;
pub const PROMPT_DOLLARQUOTE: _promptStatus = 5;
pub const PROMPT_PAREN: _promptStatus = 6;
pub const PROMPT_COPY: _promptStatus = 7;
pub type _promptStatus = libc::c_uint;
pub use self::_promptStatus as promptStatus_t;
pub const PQUOTE_PLAIN: PsqlScanQuoteType = 0;
pub const PQUOTE_SQL_LITERAL: PsqlScanQuoteType = 1;
pub const PQUOTE_SQL_IDENT: PsqlScanQuoteType = 2;
pub const PQUOTE_SHELL_ARG: PsqlScanQuoteType = 3;
pub type PsqlScanQuoteType = libc::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct PsqlScanCallbacks {
    pub get_variable: ::core::option::Option<
        unsafe extern "C" fn(
...
extern "C" {
    pub fn psql_scan_set_passthrough(state: PsqlScanState, passthrough: *mut libc::c_void);
}
extern "C" {
...
extern "C" {
    pub fn SendPGResultToShard(pg_result: *mut PGresult);
}
extern "C" {
    pub fn openQueryOutputFile(
...
extern "C" {
    pub fn setQFout(fname: *const libc::c_char) -> bool;
}
extern "C" {
    pub fn psql_get_variable(
        varname: *const libc::c_char,
        quote: PsqlScanQuoteType,
        passthrough: *mut libc::c_void,
    ) -> *mut libc::c_char;
...
extern "C" {
    pub fn NoticeProcessor(arg: *mut libc::c_void, message: *const libc::c_char);
}
extern "C" {
    pub static mut sigint_interrupt_enabled: sig_atomic_t;
}
extern "C" {
    pub static mut sigint_interrupt_jmp: sigjmp_buf;
}
extern "C" {
    pub fn psql_setup_cancel_handler();
}
extern "C" {
    pub fn SetShellResultVariables(wait_result: libc::c_int);
}
extern "C" {
    pub fn PSQLexec(query: *const libc::c_char) -> *mut PGresult;
}
extern "C" {
    pub fn PSQLexecWatch(
        query: *const libc::c_char,
        opt: *const printQueryOpt,
        printQueryFout: *mut FILE,
        min_rows: libc::c_int,
    ) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn standard_strings() -> bool;
}
extern "C" {
    pub fn session_username() -> *const libc::c_char;
}
extern "C" {
    pub fn expand_tilde(filename: *mut *mut libc::c_char);
}
extern "C" {
    pub fn recognized_connection_string(connstr: *const libc::c_char) -> bool;
}
