...
static void write_key_provider_info(KeyringProviderFileRecord *record, bool write_xlog);
...
void
redo_key_provider_info(KeyringProviderFileRecord *xlrec)
{
...
static void
write_key_provider_info(KeyringProviderFileRecord *record, bool write_xlog)
{
...
#ifndef FRONTEND
		XLogBeginInsert();
		XLogRegisterData((char *) record, sizeof(KeyringProviderFileRecord));
...
get_keyring_info_file_record_by_name(char *provider_name, Oid database_id,
									 KeyringProviderFileRecord *record)
{
...
save_new_key_provider_info(KeyringProviderRecord *provider, Oid databaseId, bool write_xlog)
{
	...
	int			new_provider_id;
	KeyringProviderFileRecord file_record;
